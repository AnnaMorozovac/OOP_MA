...
public class CustonList<T>
{
    ...
    public int CountGreaterThan(T element)
    {
        ...
        {
            if (string.Compare(list[i].ToString(), element.ToString()) > 0)
                count++;
        }
    ...
    public T Max()
    {
        ...
        for (int i = 0; i < list.Count; i++)
        {
            if (string.Compare(list[i].ToString(), tempMax.ToString()) > 0)
                tempMax = list[i];
        }
        return tempMax;
    }
    ...
    public T Min()
    {
        ...
        for (int i = 0; i < list.Count; i++)
        {
            if (string.Compare(list[i].ToString(), tempMin.ToString()) < 0)
                tempMin = list[i];
        }
