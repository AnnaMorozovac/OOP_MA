...
{
    /// <inheritdoc />
    public partial class BillsPaymentInitialSetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PaymentMethod_OneAccount", "( (BankAccountId IS NULL AND CreditCardId IS NOT NULL) \r\n                    OR (BankAccountId IS NOT NULL AND CreditCardId IS NULL) )");
                    table.ForeignKey(
